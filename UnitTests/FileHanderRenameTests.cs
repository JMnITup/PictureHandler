...
namespace UnitTests {
    ...
    public class FileHanderRenameTests {
        ...
        public void RenameJpgWithMinValueDateThrowsFileLoadException() {
            RenameJpgWithSpecifiedDate(DateTime.MinValue);
        }

        [TestMethod]
        [ExpectedException(typeof(FileLoadException))]
        public void RenameJpgWithMaxValueDateThrowsFileLoadException() {
            RenameJpgWithSpecifiedDate(DateTime.MaxValue);
        }

        [TestMethod]
        [ExpectedException(typeof(FileLoadException))]
        public void RenameJpgWithFutureDateThrowsFileLoadException() {
